...
[Serverless Stack](http://serverless-stack.com) is a free comprehensive guide to creating full-stack serverless applications. We create a [event taking app](http://demo.serverless-stack.com) from scratch.
...
- [Add a Create Note API](../../tree/add-a-create-event-api)
- [Add a Get Note API](../../tree/add-a-get-event-api)
- [Add a List All the Notes API](../../tree/add-a-list-all-the-events-api)
- [Add an Update Note API](../../tree/add-an-update-event-api)
- [Add a Delete Note API](../../tree/add-a-delete-event-api)
